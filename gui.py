...
class ButtonReadme(ButtonExcel):
    def __init__(self):
        super().__init__()
        self.readme_button = tk.Button(root, text='Como utilizar', command=None)
        self.readme_button.place(x=125,y=150)

class ExecuteButton(ButtonReadme):
    def __init__(self):
        super().__init__()
